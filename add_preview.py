#!/usr/bin/env python3
"""Insert screensaver preview image into barcode.sav at code offset 256."""
...
BARCODE_SAV   = os.path.join(os.path.dirname(__file__), 'barcode.sav')
